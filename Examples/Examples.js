...
<div class="mysidenav" id= "mysidenav">
  ...
  <button class="mydropdown-btn">Reservoir Computing Examples<i class="fa fa-caret-down"></i></button>
    <div class="mydropdown-container">
      ...
      <a href="https://quantumyilmaz.github.io/MTFS21/Examples/3bar/3barrier.html">Triple-Barrier Method (WIP)</a>
    </div>
...
var mydropdown = document.getElementsByClassName("mydropdown-btn");
for (i = 0; i < mydropdown.length; i++) {
    mydropdown[i].addEventListener("click", function() {
    this.classList.toggle("active");
    var mydropdownContent = this.nextElementSibling;
...
var menu_button = document.getElementsByClassName("new")[0];
menu_button_width = menu_button.style.width;

menu_button.addEventListener("click", function() {
    this.classList.toggle("active");
    this.style.width = menu_button_width.toString();
    this.innerHTML = "&#9776;";
    var mysidenav = document.getElementsByClassName("mysidenav")[0];
    if (mysidenav.style.display === "block") {
        mysidenav.style.display = "none";
    } else {
        this.innerHTML = "&#9776;" +" Menu";
        this.style.width = "12.55%";
